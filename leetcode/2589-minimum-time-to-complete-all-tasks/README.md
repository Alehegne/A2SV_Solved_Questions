...
**Problem:** [Minimum-Time-to-Complete-All-Tasks](https://leetcode.com/problems/minimum-time-to-complete-all-tasks)
...
- `1 <= start i , end i <= 2000`

- `1 <= duration i <= end i - start i + 1`